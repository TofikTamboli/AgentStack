...
void main() {
  ...
  // Static subtle background outline
  float base = (1.0 - smoothstep(0.0, uBaseWidth, abs(d))) * 0.25;

  // Single short light streak
  vec2 nEll = normalize(p / (uHalfSize * uHalfSize) + 1e-6);
  float cosAngle = dot(nEll, L);
  float phi = acos(clamp(cosAngle, -1.0, 1.0));
